...
<div class="container-fluid">
    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4" id="main">
        ...
        <div id="insert_data" class="view">
         <form action="" enctype="multipart/form-data" id="form_data">
            <div class="row">
              <div class="col">
                  <label for="imagen">Imagen</label>
                <input type="file" id="archivo" name="archivo" class="form-control" accept="image/x-png,image/gif,image/jpeg" style=" padding-bottom: 10px;    height: 48px; ">
  ...
  <script>
    ...
    function consultar(){
      let obj = {
        "action" : "consultar_slider"
      };
      $.post("Backend/includes/_funciones.php", obj, function(respuesta){
        let template = ``;
...
function insertar(){
      ...
      $.post("Backend/includes/uploadFile.php", obj, function(){
      });
